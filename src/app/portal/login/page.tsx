      ...
      >
        ...
        <div className="bg-[#1E1E24] border border-[#40424D] rounded-2xl p-8">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full flex items-center justify-center gap-3 bg-[#252530] hover:bg-[#2a2a38] border border-[#40424D] text-[#EDEFF7] rounded-xl px-6 py-3.5 text-sm font-medium transition-colors"
          >
          ...
          <p className="text-[#6E7180] text-xs text-center mt-4">
            Select your @mytronlabs.com account to continue
          </p>
        </div>
