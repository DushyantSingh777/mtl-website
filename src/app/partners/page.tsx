            ...
            {partnerTypes.map((pt, i) => (
              <AnimatedSection key={i} delay={i * 100}>
                <div className="glass-card p-8 h-full group">
                  <div className="font-display text-2xl font-bold text-tron-purple/20 mb-2">
                    ...
                    <ul className="space-y-2">
                      {pt.benefits.map((b, j) => (
                        <li key={j} className="flex gap-3 text-tron-text text-sm">
                          <span className="w-1.5 h-1.5 rounded-full bg-tron-purple mt-1.5 flex-shrink-0" />
                          {b}
                        </li>
                      ))}
                    </ul>
          ...
          <AnimatedSection>
            <div className="glass-card p-10 text-center">
              ...
              <p className="font-body text-tron-text text-lg leading-relaxed max-w-2xl mx-auto">
                MyTron Labs is in its early stages, which means right now is the best time to
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          <AnimatedSection>
            <h2 className="section-heading text-4xl md:text-5xl text-white mb-6">
              BECOME AN{" "}
              <span className="gradient-text">EARLY PARTNER</span>
            </h2>
